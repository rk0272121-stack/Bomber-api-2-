...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text.isdigit() and len(text) >= 10:
        ...
        if is_premium(user_id):
            ...
            duration = DEFAULT_FREE_DURATION
            is_free = True
            attack_label = "🆓 Free"
...
# ============ MAIN FUNCTION - FIXED FOR BOTH VERCEL & RENDER ============
def run_bot():
    try:
...
def main():
    # Flask web server thread start karo (for Render)
